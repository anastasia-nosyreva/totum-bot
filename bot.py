...
COURSE_ACTIVITIES = {
    ...
    "Компьютерная грамотность (3–4 класс)": (
        "🖥 Научим уверенно работать на ПК — печатать текст, работать с файлами и папками, "
        "скачивать и устанавливать программы, безопасно вести себя в интернете\n"
        "📄 Сформируем навык работы с офисными программами — Word, Excel, PowerPoint, "
        "создание электронной почты, создание фото, анимаций и коллажей\n"
        "🎮 Создадим свои первые проекты — мультики в Scratch и собственные игры "
        "без программирования"
    ),
    "Программирование": (
        "🐍 Научим программировать на Python — писать и читать код, "
        "строить алгоритмы и решать базовые задачи по математике\n"
        "⛏️ Научим программировать в Minecraft — создавать свои миры "
        "и игровые механики, программировать персонажей и решать "
        "практические задачи (телепортация, строительство дома)\n"
        "🎮 Создадим свои первые проекты — разработаем мини-игры, "
        "научимся разбивать сложные задачи на шаги и анализировать "
        "логику программ"
    ),
    "Искусственный интеллект и нейросети": (
...
async def cb_send(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.answer(
        "📤 Ниже готовая обратная связь — перенаправь её "
        "ответственному специалисту из УМО.",
    )
    await call.message.answer(
